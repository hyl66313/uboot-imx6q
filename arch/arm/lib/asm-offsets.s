...
@ -imultilib armv7-a/default
@ -iprefix /opt/toolchain/gcc-4.6.2/fsl-linaro-toolchain/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.6.2/
@ -isysroot /opt/toolchain/gcc-4.6.2/fsl-linaro-toolchain/bin/../arm-fsl-linux-gnueabi/multi-libs
@ -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x17800000 -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/toolchain/gcc-4.6.2/fsl-linaro-toolchain/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.6.2/include
...
@ -mword-relocations -msoft-float -march=armv7-a
