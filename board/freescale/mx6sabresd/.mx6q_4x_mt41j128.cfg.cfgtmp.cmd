cmd_board/freescale/mx6sabresd/mx6q_4x_mt41j128.cfg.cfgtmp := arm-fsl-linux-gnueabi-gcc -E -Wp,-MD,board/freescale/mx6sabresd/.mx6q_4x_mt41j128.cfg.cfgtmp.d  -nostdinc -isystem /opt/toolchain/gcc-4.6.2/fsl-linaro-toolchain/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.6.2/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000    -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations   -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe  -march=armv7-a     -x c -o board/freescale/mx6sabresd/mx6q_4x_mt41j128.cfg.cfgtmp board/freescale/mx6sabresd/mx6q_4x_mt41j128.cfg
